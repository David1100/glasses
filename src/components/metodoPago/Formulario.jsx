    ...
    return (
        <>
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div class="flex flex-col gap-5 px-0 border-t border-slate-800/50 py-6">
                ...
                <div className="flex flex-col gap-2 mt-2">
                    <div className="flex justify-between items-end">
                        ...
                        >
                            <RiBallPenLine className="material-symbols-outlined text-[16px]" />
                            Firma digital
                        </label>
                        <button
                    ...
                    <div
                        className="relative w-full h-32 rounded-xl bg-[#132023] border-2 border-dashed border-slate-800 hover:border-primary/50 transition-colors cursor-crosshair overflow-hidden group/canvas"
                    >
                        <div
                            className="absolute inset-0 flex items-center justify-center text-gray-400/30 pointer-events-none group-hover/canvas:text-gray-400/50"
                        >
                            <span className="text-sm font-medium"
                            >Dibuja tu firma aquí</span>
                        </div>
                        <svg
                            className="absolute inset-0 w-full h-full pointer-events-none opacity-0 group-hover/canvas:opacity-10 transition-opacity"
                            viewbox="0 0 400 150"
                        >
                            <path
