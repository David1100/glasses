    ...
    return (
        <>
            <div className="flex items-center gap-4 text-sm font-medium mb-2 py-4">
                <a href="carrito" className={`${step == 1 ? 'text-secondary' : null}`}>Carrito</a>
                <RiArrowRightSLine  className="material-symbols-outlined text-gray-600 text-sm"/>
                <a href="pago" className={`${step == 2 ? 'text-secondary' : null}`}>Envio</a>
                <RiArrowRightSLine  className="material-symbols-outlined text-gray-600 text-sm"/>
                <span className={`${step == 3 ? 'text-secondary' : null}`}>Pago</span>
            </div>
        </>
    )
}